...
const session_cookie_name = 'computacion-webapp-token';
const user_email_cookie_name = 'computacion-webapp-email';
const user_id_cookie_name = 'computacion-webapp-user_id';
const user_complete_name_cookie_name = 'computacion-webapp-user_complete_name';
const group_name_cookie_name = 'computacion-webapp-group_name';
const codigo_cookie_name = 'computacion-webapp-codigo';
